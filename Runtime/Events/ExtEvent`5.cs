namespace ExtEvents
{
    ...
    [Serializable]
    public class ExtEvent<T1, T2, T3, T4, T5> : BaseExtEvent
    {
        private readonly unsafe void*[] _arguments = new void*[5];

        private Type[] _eventParamTypes;
        protected override Type[] EventParamTypes => _eventParamTypes ??= new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) };

        /// <summary>
        /// The dynamic listeners list that you can add your listener to.
        /// </summary>
        [PublicAPI]
        public event Action<T1, T2, T3, T4, T5> DynamicListeners;
        ...
        public void Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
        {
            ...
            DynamicListeners?.Invoke(arg1, arg2, arg3, arg4, arg5);
        }

        public static ExtEvent<T1, T2, T3, T4, T5> operator +(ExtEvent<T1, T2, T3, T4, T5> extEvent, Action<T1, T2, T3, T4, T5> listener)
        {
            if (extEvent == null)
                return null;
